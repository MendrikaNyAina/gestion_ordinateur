                    ...
                    <body>
                         ...
                         <div class="pcoded-main-container">
                              <div class="pcoded-content">
                                   <h:Card>
                                        <h:CardBody>
                                             <h:CardTitle>Commission par mois</h:CardTitle>
                                             <h3>Choisir une année </h3>
                                             <form action="/admin/stat-commission" method="get">
                                             ...
                                             <div id="chart"></div>
                                             <br>
                                             <h:Link href="/admin/stat-commission/${year}/pdf">Exporter en pdf
                                             </h:Link>
                                        </h:CardBody>
                                   </h:Card>
                                   <h:Card>
                                        <h:CardBody>
                                             <h:CardTitle>Commission par magasin par mois, tableau</h:CardTitle>
                                             <c:choose>
                                                  <c:when test="${not empty table}">
                                                       <h:Table column="[\"magasin\",\" mois\",\"vente\",\"commission\"]" classe="table-bordered">
