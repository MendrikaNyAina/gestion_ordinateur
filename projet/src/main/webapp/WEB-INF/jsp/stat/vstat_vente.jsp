     ...
     <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
          <%@taglib prefix="h" uri="http://www.front.org/html.tags" %>
               <%@taglib prefix="g" uri="http://www.front.org/page.tags" %>
                    <!DOCTYPE html>
                    <html lang="en">
                    <g:Head title="Vente" isChart="true">
                              ...
                              <div class="pcoded-content">
                                   <h:Card>
                                        <h:CardBody>
                                             ...
                                             <form action="/admin/stat-vente-mois" method="get">
                                             ...
                                             <div id="chart"></div>
                                             <br>
                                             <h:Link href="/admin/stat-vente-mois/${year}/pdf">Exporter en pdf</h:Link>
                                        </h:CardBody>
                                   </h:Card>
                                   <h:Card>
                                        <h:CardBody>
                                             <h:CardTitle>Vente par mois, tableau</h:CardTitle>
                                             <c:choose>
