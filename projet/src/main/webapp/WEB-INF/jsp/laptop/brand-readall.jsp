               ...
               <%@taglib prefix="g" uri="http://www.front.org/page.tags" %>
                    <%@page import="java.util.ArrayList, app.code.model.*" %>
                         <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                              <!DOCTYPE html>
                              <html lang="en">
                              <g:Head title="Gestion marque" isSelect2="true" isSweetAlert="true">
                                        ...
                                        <div class="pcoded-content">
                                             <h:Card>
                                                  <h:CardBody lg="4" md="4" xs="6">
                                                       <h:CardTitle>Ajouter une marque</h:CardTitle>
                                             ...
                                             <h:Card>
                                                  <h:CardBody>
                                                       <h:CardTitle>Liste des Marques</h:CardTitle>
                                                       ...
                                                       <c:choose>
                                                            <c:when test="${not empty brands}">
                                                                 <h:Table column="[\"
                                                                      ...
                                                                      <c:forEach var="elt" items="${brands}">
                                                                           <tr>
                                                                                <td>
                                                                                ...
                                                                                <td>
                                                                                     <h:Link
                                                                                          href="/admin/brand/delete/${elt.id}"
                                                            ...
                                                            <c:otherwise>
                                                                 <h:Alert color="danger">Aucune donnée de marque
                                                                 </h:Alert>
                                                            </c:otherwise>
                                                       </c:choose>
                                                  </h:CardBody>
