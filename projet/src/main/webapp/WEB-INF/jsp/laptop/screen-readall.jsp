               ...
               <%@taglib prefix="g" uri="http://www.front.org/page.tags" %>
                    <%@page import="java.util.ArrayList, app.code.model.*" %>
                         <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                              <!DOCTYPE html>
                              <html lang="en">
                              <g:Head title="gestion de Ecran" isSelect2="true" isSweetAlert="true">
                              ...
                              <body>
                                   ...
                                   <div class="pcoded-main-container">
                                        <div class="pcoded-content">
                                             <h:Card>
                                                  <h:CardTitle>Ajouter un Ecran</h:CardTitle>
                                                  <h:CardBody lg="4" md="4" xs="6">
                                                       <form action="/admin/screen" method="post">
                                                       ...
                                                       <c:choose>
                                                            <c:when test="${not empty screens}">
                                                                 <h:Table column="[\"
                                                                      ...
                                                                      <c:forEach var="elt" items="${screens}">
                                                                           <tr>
                                                                                <td>
                                                                                ...
                                                                                <td>
                                                                                     <h:Link
                                                                                          href="/admin/screen/delete/${elt.id}"
