               ...
               <%@taglib prefix="g" uri="http://www.front.org/page.tags" %>
                    <%@page import="java.util.ArrayList, app.code.model.*" %>
                         <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                              <!DOCTYPE html>
                              <html lang="en">
                              <g:Head title="Reference laptop" isSelect2="true">
                              ...
                              <body>
                                   ...
                                   <div class="pcoded-main-container">
                                        <div class="pcoded-content">
                                             <h:Card>
                                                  <h:CardBody>
                                                       <h:CardTitle>Liste des references de laptop</h:CardTitle>
                                                       <h2 class="card-title">Filtre</h2>
                                                       <form action="/admin/laptops" method="get">
                                                            <h:Row>
                                                                 ...
                                                                 <c:if test="${v_stock!=null}">
                                                                      ...
                                                                      <h:Col lg="3" md="3" xs="4">
                                                                           <h:MultiSelect name="screenType"
                                                                                label="screen Type" id="screenType">
                                                                                <c:if test="${screenType!=null}">
                                                                                     <c:forEach items="${screenType}"
                                                                                          var="elt">
                                                                                          <c:choose>
                                                                                               <c:when
                                                                                                    test="${v_stock.screenType!=null}">
                                                                                                    <c:forEach
                                                                                                         items="${v_stock.screnType}"
                                                                                                         var="elt2">
                                                                                                         <c:choose>
                                                                                                              <c:when
                                                                                                                   test="${elt.id==elt2}">
                                                       ...
                                                       <c:choose>
                                                            <c:when test="${not empty laptops}">
                                                                 <h:Table column="[\"
                                                                      reference\",\"marque\"
                                                                      ,\"ram\",\"rom
                                                                      \",\"processor\",\"ecran\",\"voir\"]"
                                                                      classe="table-bordered">
                                                                      <c:forEach var="elt" items="${laptops}">
                                                                           <tr>
                                                                                <td>${elt.reference}</td>
                                                                                ...
                                                                                <td>${elt.screenType.name}, ${elt.sizeScreen} pouces</td>

                                                                                <td>
                                                                                     <h:Link color="info"
                                                                                          href="/admin/laptop/update/${elt.id}">Modifier
                                                                                     </h:Link>
                                                                                </td>
                                                                           </tr>
                                                                      </c:forEach>
                                                                 ...
                                                                 <h:Pagination nbr="${totalPage}" current="${page}"
                                                                      link="/admin/laptops"></h:Pagination>
                                                            </c:when>
                                                            <c:otherwise>
                                                                 <h:Alert color="danger">Aucune donnée de reference de laptop
                                                                 </h:Alert>
                                                            </c:otherwise>
                                                       </c:choose>
                                                  </h:CardBody>
