               ...
               <%@taglib prefix="g" uri="http://www.front.org/page.tags" %>
                    <%@page import="java.util.ArrayList, app.code.model.*" %>
                         <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                              <!DOCTYPE html>
                              <html lang="en">
                              <g:Head title="Reception" isSelect2="true" isSweetAlert="true">
                              ...
                              <body>
                                   ...
                                   <div class="pcoded-main-container">
                                        <div class="pcoded-content">
                                             <h:Card>
                                                  <h:CardBody>
                                                       <h:CardTitle>Liste des Renvoies attendu</h:CardTitle>
                                                       <h2 class="card-title">Choisir la date</h2>
                                                       <form action="/admin/stock/receipt" method="get">
                                                            <h:Row>
                                                       ...
                                                       <c:choose>
                                                            <c:when test="${not empty transferts}">
                                                                 <form action="/admin/stock/receipt" method="post" id="form">
