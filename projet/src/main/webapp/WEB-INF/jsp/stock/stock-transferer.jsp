     ...
     <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
          <%@taglib prefix="h" uri="http://www.front.org/html.tags" %>
               <%@taglib prefix="g" uri="http://www.front.org/page.tags" %>
                    <!DOCTYPE html>
                    <html lang="en">
                    <g:Head title="Transferer" isSelect2="true" isJquery="true" isDynamicForm="true"
                         isSweetAlert="true">
                    ...
                    <body>
                         ...
                         <div class="pcoded-main-container">
                              <div class="pcoded-content">
                                   <h:Card>
                                        <h:CardBody>
                                             <h:CardTitle>Transferer des Laptop</h:CardTitle>
                                             <form action="" id="form" autocomplete="off">
                                                  <h:Row>
                                                       ...
                                                       <h:Col lg="4" md="4" xs="6">
                                                            <h:Select name="store_id" id="store_id" label="Magasin">
                         ...
                         <script type="text/javascript">
                              ...
                              const url = "/admin/stock/transferer";
